...
import 'package:expense_tracker_app/features/auth/domain/usecases/current_user.dart';
...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  void _handleLoginError(Failure error, Emitter<AuthState> emit) {
